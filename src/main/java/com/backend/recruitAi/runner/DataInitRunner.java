...
public class DataInitRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (memberRepository.count() == 0) {
            ...
            // ✅ 첫 번째 InterviewResult 먼저 저장
            InterviewResult interviewResult1 = InterviewResult.builder()
                    .member(kakaoMember)
                    .createdAt(LocalDateTime.now().minusHours(24))
                    .build();
            InterviewResult savedResult1 = interviewResultService.saveInterviewResult(interviewResult1);
            ...
            savedResult1.setAnswerAnalyses(Arrays.asList(answer1_1, answer1_2));
            interviewResultService.saveInterviewResult(savedResult1);
            System.out.println("✅ 첫 번째 InterviewResult 저장 완료: ID = " + savedResult1.getId());

            // ✅ 두 번째 InterviewResult도 같은 방식
            InterviewResult interviewResult2 = InterviewResult.builder()
                    .member(kakaoMember)
                    .createdAt(LocalDateTime.now())
                    .build();
            InterviewResult savedResult2 = interviewResultService.saveInterviewResult(interviewResult2);
            ...
            savedResult2.setAnswerAnalyses(Arrays.asList(answer2_1, answer2_2, answer2_3));
            interviewResultService.saveInterviewResult(savedResult2);
            System.out.println("✅ 두 번째 InterviewResult 저장 완료: ID = " + savedResult2.getId());
